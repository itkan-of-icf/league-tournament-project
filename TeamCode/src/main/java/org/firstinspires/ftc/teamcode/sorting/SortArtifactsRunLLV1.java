...
@TeleOp
public class SortArtifactsRunLLV1 extends LinearOpMode {
  ...
  /*          if (gamepad1.y) {
         ...
         /*   List<LLResultTypes.FiducialResult> fiducials = result.getFiducialResults();
            ...
            if (gamepad1.x) {
                ...
                boolean v1 = ((getDetectedColorSlot1() && getDetectedColorSlot2() && getDetectedColorSlot3()) ||
                        (!getDetectedColorSlot1() && !getDetectedColorSlot2() && !getDetectedColorSlot3())
                        || (getDetectedColorSlot1() == null || getDetectedColorSlot2() == null || getDetectedColorSlot3() == null)) ;

                // case 2: GGP - rand
                boolean v2 = (getDetectedColorSlot1() && getDetectedColorSlot2() && !getDetectedColorSlot3());

                //case 3: GPG - rand
                boolean v3 = (getDetectedColorSlot1() && !getDetectedColorSlot2() && getDetectedColorSlot3());

                //case 5: PGG - rand
                boolean v4 = (!getDetectedColorSlot1() && getDetectedColorSlot2() && getDetectedColorSlot3());
